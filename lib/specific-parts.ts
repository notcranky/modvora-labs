...
// ── URL helpers ────────────────────────────────────────────────────────────────
// Summit Racing: vehicle-filtered catalog — shows only parts that fit {year} {make} {model}
const SUMMIT_V = (q: string) =>
  `https://www.summitracing.com/search?searchterm=${encodeURIComponent(q)}&vehicleYear={year}&vehicleMake={make}&vehicleModel={model}`

// eBay Motors: compatibility-filtered search for the exact product + vehicle
const EBAY_V = (q: string) =>
  `https://www.ebay.com/sch/i.html?_nkw=${encodeURIComponent(q)}+{year}+{make}+{model}&_sacat=33743&LH_ItemCondition=1000&_sop=12`

// JEGS: vehicle-filtered search
const JEGS_V = (q: string) =>
  `https://www.jegs.com/search#q={year}+{make}+{model}+${encodeURIComponent(q)}`
    ...
    products: [
      {
        ...
        retailers: [
          { name: 'K&N — Find My Exact Intake', icon: '🌐', url: 'https://www.knfilters.com/find-a-filter?type=filtercharger&year={year}&make={make}&model={model}' },
      ...
      },
      {
        ...
        retailers: [
          { name: 'AEM — Find My Exact Intake', icon: '🌐', url: 'https://www.aemintakes.com/search?search_query={year}+{make}+{model}+intake' },
      ...
      },
      {
        ...
        retailers: [
          { name: 'Injen — Shop My Vehicle', icon: '🌐', url: 'https://injen.com/search?type=product&q={year}+{make}+{model}+intake' },
      ...
      },
      {
        ...
        retailers: [
          { name: 'aFe — Shop My Vehicle', icon: '🌐', url: 'https://afepower.com/search?query={year}+{make}+{model}+intake' },
    ...
    products: [
      {
        ...
        retailers: [
          { name: 'Borla — Find My Exact Exhaust', icon: '🌐', url: 'https://www.borla.com/search?q={year}+{make}+{model}+ATAK' },
      ...
      },
      {
        ...
        retailers: [
          { name: 'Borla — Find My Exact Exhaust', icon: '🌐', url: 'https://www.borla.com/search?q={year}+{make}+{model}+Touring' },
      ...
      },
      {
        ...
        retailers: [
          { name: 'MagnaFlow — Find My Exact System', icon: '🌐', url: 'https://www.magnaflow.com/search?search={year}+{make}+{model}+exhaust' },
      ...
      },
      {
        ...
        retailers: [
          { name: 'Flowmaster — Find My Exact System', icon: '🌐', url: 'https://www.flowmaster.com/vehicle-selector/?year={year}&make={make}&model={model}' },
      ...
      },
      {
        ...
        retailers: [
          { name: 'Corsa — Find My Exact Exhaust', icon: '🌐', url: 'https://www.corsaperformance.com/search?q={year}+{make}+{model}+exhaust' },
    ...
    products: [
      {
        ...
        retailers: [
          { name: 'Hooker — Shop My Vehicle', icon: '🌐', url: 'https://www.holley.com/brands/hooker/headers/?vehicleYear={year}&vehicleMake={make}&vehicleModel={model}' },
      ...
      },
      {
        ...
        retailers: [
          { name: 'BBK — Shop My Vehicle', icon: '🌐', url: 'https://www.bbkperformance.com/search?q={year}+{make}+{model}+shorty+headers' },
    ...
    products: [
      {
        ...
        retailers: [
          { name: 'BC Racing — Find My Exact Kit', icon: '🌐', url: 'https://bcracing-na.com/search?type=product&q={year}+{make}+{model}+coilovers' },
      ...
      },
      {
        ...
        retailers: [
          { name: 'KW — Find My Exact Kit', icon: '🌐', url: 'https://www.kwsuspension.com/products/?vehicleYear={year}&vehicleMake={make}&vehicleModel={model}&series=v3' },
      ...
      },
      {
        ...
        retailers: [
          { name: 'Tein — Shop My Vehicle', icon: '🌐', url: 'https://www.tein.com/search/?q={year}+{make}+{model}+flex+z' },
    ...
    products: [
      {
        ...
        retailers: [
          { name: 'Eibach — Find My Exact Springs', icon: '🌐', url: 'https://eibach.com/us/search?query={year}+{make}+{model}+pro-kit' },
      ...
      },
      {
        ...
        retailers: [
          { name: 'Eibach — Find My Exact Springs', icon: '🌐', url: 'https://eibach.com/us/search?query={year}+{make}+{model}+sportline' },
      ...
      },
      {
        ...
        retailers: [
          { name: 'H&R — Shop My Vehicle', icon: '🌐', url: 'https://www.hrsprings.com/search/?q={year}+{make}+{model}+springs' },
    ...
    products: [
      {
        ...
        retailers: [
          { name: 'Whiteline — Find My Exact Bar', icon: '🌐', url: 'https://www.whiteline.com.au/vehicle-selector?year={year}&make={make}&model={model}&category=sway-bars' },
      ...
      },
      {
        ...
        retailers: [
          { name: 'Eibach — Find My Exact Kit', icon: '🌐', url: 'https://eibach.com/us/search?query={year}+{make}+{model}+anti-roll+kit' },
    ...
    products: [
      {
        ...
        retailers: [
          { name: 'PowerStop — Find My Exact Pads', icon: '🌐', url: 'https://www.powerstop.com/search/?query={year}+{make}+{model}+brake+pads' },
      ...
      },
      {
        ...
        retailers: [
          { name: 'EBC — Find My Exact Pads', icon: '🌐', url: 'https://www.ebcbrakes.com/products/?s={year}+{make}+{model}' },
      ...
      },
      {
        ...
        retailers: [
          { name: 'Hawk — Find My Exact Pads', icon: '🌐', url: 'https://www.hawkperformance.com/parts-finder?query={year}+{make}+{model}' },
    ...
    products: [
      {
        ...
        retailers: [
          { name: 'PowerStop — Find My Exact Kit', icon: '🌐', url: 'https://www.powerstop.com/search/?query={year}+{make}+{model}+brake+kit' },
      ...
      },
      {
        ...
        retailers: [
          { name: 'Wilwood — Find My Exact Kit', icon: '🌐', url: 'https://www.wilwood.com/Search?keywords={year}+{make}+{model}' },
    ...
    products: [
      {
        ...
        retailers: [
          { name: 'Enkei — Find My Exact Fitment', icon: '🌐', url: 'https://www.enkeiusa.com/search/?q={year}+{make}+{model}+RPF1' },
      ...
      },
      {
        ...
        retailers: [
          { name: 'Method — Shop My Fitment', icon: '🌐', url: 'https://www.methodracewheels.com/search?type=product&q=MR305+{make}+{model}' },
    ...
    products: [
      {
        ...
        retailers: [
          { name: 'Michelin — Find My Size', icon: '🌐', url: 'https://www.tirerack.com/tires/TireSearchResults.jsp?zip-code=00000&width=&ratio=&diameter=&rearWidth=&rearRatio=&rearDiameter=&performance=ALL' },
      ...
      },
      {
        ...
        retailers: [
          { name: 'Continental — Find My Size', icon: '🌐', url: 'https://www.discounttire.com/search?text=Continental+ExtremeContact+Sport+02' },
    ...
    products: [
      {
        ...
        retailers: [
          { name: 'APR — Shop My Vehicle', icon: '🌐', url: 'https://www.aprperformance.com/search?type=product&q={year}+{make}+{model}+front+splitter' },
    ...
    products: [
      {
        ...
        retailers: [
          { name: 'LLumar — Find an Installer', icon: '🌐', url: 'https://llumar.com/na/en/automotive/dealer-locator/' },
          { name: 'eBay Motors (your vehicle)', icon: '🏷️', url: EBAY_V('LLumar CTX ceramic window tint film') },
          { name: 'Summit Racing (your vehicle)', icon: '🏁', url: SUMMIT_V('LLumar window tint film') },
        ],
      },
      {
        id: '3m-crystalline',
        ...
        retailers: [
          { name: '3M — Find an Installer', icon: '🌐', url: 'https://www.3m.com/3M/en_US/p/d/b5005097097/' },
          { name: 'eBay Motors (your vehicle)', icon: '🏷️', url: EBAY_V('3M Crystalline window tint film') },
          { name: 'Summit Racing (your vehicle)', icon: '🏁', url: SUMMIT_V('3M window tint film') },
        ],
      },
      {
        id: 'gila-diy-tint',
        ...
        retailers: [
          { name: 'Gila — Buy Direct', icon: '🌐', url: 'https://www.amazon.com/Gila-Heat-Shield-Automotive-Window/dp/B0015R5EZC' },
          { name: 'eBay Motors (your vehicle)', icon: '🏷️', url: EBAY_V('Gila window tint film') },
          { name: 'Summit Racing (your vehicle)', icon: '🏁', url: SUMMIT_V('window tint film DIY') },
        ],
      },
    ],
  },
    ...
    products: [
      {
        ...
        retailers: [
          { name: 'APR — Shop This Wing', icon: '🌐', url: 'https://www.aprperformance.com/search?type=product&q=GT-250+wing' },
    ...
    products: [
      {
        ...
        retailers: [
          { name: 'Morimoto — Find My Exact Lights', icon: '🌐', url: 'https://www.theretrofitsource.com/search?q={year}+{make}+{model}+XB+LED+headlights' },
      ...
      },
      {
        ...
        retailers: [
          { name: 'OPT7 — Find My Bulb Size', icon: '🌐', url: 'https://www.opt7.com/pages/led-headlight-bulb-fitment?year={year}&make={make}&model={model}' },
      ...
      },
      {
        ...
        retailers: [
          { name: 'Spyder — Find My Exact Lights', icon: '🌐', url: 'https://www.carid.com/search/{year}%20{make}%20{model}%20Spyder%20headlights.html' },
  ...
  // ── SHORT SHIFTER ────────────────────────────────────────────────────────────
  {
    ...
    products: [
      ...
      },
      {
        ...
        retailers: [
          { name: 'Cobb — Find My Exact Shifter', icon: '🌐', url: 'https://www.cobbtuning.com/search/?q={year}+{make}+{model}+short+shifter' },
    ...
    products: [
      {
        ...
        retailers: [
          { name: 'Recaro — Shop the Sport C', icon: '🌐', url: 'https://www.recaro-automotive.com/us/product-categories/sport-seats' },
    ...
    products: [
      {
        ...
        retailers: [
          { name: 'Cobb — Find My Exact Accessport', icon: '🌐', url: 'https://www.cobbtuning.com/search/?q={year}+{make}+{model}+Accessport' },
      ...
      },
      {
        ...
        retailers: [
          { name: 'DiabloSport — Find My Trinity 2', icon: '🌐', url: 'https://www.diablosport.com/?s={year}+{make}+{model}+trinity+2' },
    ...
    products: [
      {
        ...
        retailers: [
          { name: 'Precision — Buy the PT6266', icon: '🌐', url: 'https://www.precisionturbo.net/product-category/turbochargers/' },
      ...
      },
      {
        ...
        retailers: [
          { name: 'ProCharger — Find My Exact Kit', icon: '🌐', url: 'https://www.procharger.com/search/?q={make}+{model}+supercharger' },
      ...
      },
      {
        ...
        retailers: [
          { name: 'Vortech — Find My Exact Kit', icon: '🌐', url: 'https://vortechsuperchargers.com/search/?q={make}+{model}+supercharger' },
