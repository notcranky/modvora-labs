...
const samplePosts: CommunityPost[] = [
  ...
  },
  {
    ...
    description: 'Stage 2 coilovers, cat-back exhaust, and a wheel swap done right. Still daily driven, still sounds mean. Every part logged and receipts saved.',
  ...
  },
  {
    ...
    description: 'Intake, brake upgrade, new rubber, and a set of HRE wheels. S55 is properly awake now. Next up is an exhaust and a tune.',
